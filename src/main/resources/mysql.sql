...
CREATE TABLE `user` (
  ...
  `name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `telephone` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `qqOpenId` VARCHAR(60) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`userid`),
...
insert  into `user`(`userid`,`username`,`password`,`name`,`telephone`) values ('3af57d0545766ec940d2c32a6567cc06ae5','jack','1234','张三','15588888888'),('734hdak3kfd389jgh3kll4590wejrh983jk','tom','4321','张茜茜','13888888888'),('88e6ec6c-6d17-43a7-8782-d1eae394d802','jackson','2222','刘霜','13782345627');
